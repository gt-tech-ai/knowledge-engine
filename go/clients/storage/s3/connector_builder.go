...
// NewConnectorClientBuilder returns the per-connector S3-client builder BOTH connector composition roots
// (the API and the document-events worker) share — the ~30-line buildS3Client closure they previously

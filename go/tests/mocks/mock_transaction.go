...
//
//	mockgen -destination=../../tests/mocks/mock_transaction.go -package=mocks github.com/gt-tech-ai/knowledge-engine/go/core/interfaces Transaction,TransactionManager
//

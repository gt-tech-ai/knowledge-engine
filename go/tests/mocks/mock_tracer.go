...
// Source: github.com/gt-tech-ai/knowledge-engine/go/core/interfaces (interfaces: Tracer,Span)
//
// Generated by this command:
//
//	mockgen -destination=../../tests/mocks/mock_tracer.go -package=mocks github.com/gt-tech-ai/knowledge-engine/go/core/interfaces Tracer,Span
//
...
func (m *MockTracer) Start(ctx context.Context, name string, opts ...interfaces.SpanOption) (context.Context, interfaces.Span) {
	m.ctrl.T.Helper()
...
func (m *MockSpan) SetStatus(code interfaces.SpanStatusCode, description string) {
	m.ctrl.T.Helper()

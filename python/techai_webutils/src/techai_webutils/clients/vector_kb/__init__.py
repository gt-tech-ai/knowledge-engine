"""Knowledge-base clients (Go Layer-2 adapters behind ``core.interfaces.knowledge_base``).
...
``KnowledgeBaseIngestor`` start/poll job) —. Package shape: builder at top,
each backend its own subpackage.
"""
